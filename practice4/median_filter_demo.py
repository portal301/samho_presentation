...
print("=" * 60)
print("중간값 필터 데모 시작 - z: 원본, x: 필터, ESC: 종료")
print("=" * 60)
...
img1_f = cv2.medianBlur(img1, 5)
img2_f = cv2.medianBlur(img2, 5)

window_name = "Median Filter Demo (z: original, x: filtered, ESC: quit)"
